...
import { ApiError, lookupRequest, type LookupResult } from '@/lib/api';
...
<template>
  <section>
    ...
    <p class="mt-2 text-sm text-ink-soft">提交点歌时给的那 6 位码，字母不分大小写。</p>
    ...
    <p v-if="failure" class="mt-3 text-sm text-orange-deep">
      {{ failure }}
    </p>
    ...
    <div v-if="result" class="paper-card mt-5 border-l-4 p-5" :class="accent">
      <div class="flex items-start gap-3">
        ...
        <div class="min-w-0">
          ...
          <h2 class="mt-1 truncate text-xl">
            {{ result.title }}
          </h2>
